        ...
        <section class="login">
            ...
            <form action="">
                ...
                <div class="input-form">
                    ...
                    <input name="email" type="text" class="input" placeholder="Insira seu email">
                </div>
                ...
                <div class="input-form">
                    ...
                    <input name="password" type="password" class="input" placeholder="Insira sua senha">
                </div>
                ...
                <p class="create-account">Ainda não possui uma conta? <span class="span">Criar Conta</span>

                <p class="divider-logins line">Ou</p>
